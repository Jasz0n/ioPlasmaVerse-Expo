...
export default function NftGalery() {
  /* ---------------------------------------------------------------
     State Variables
  --------------------------------------------------------------- */
  const [activeTab, setActiveTab] = useState<"nft" | "ownedNft">("nft");
  ...
  return (
    <ThemedView style={styles.container}>
      ...
      <View style={styles.buttonContainer}>
        <TouchableOpacity
          style={[styles.button, activeTab === "ownedNft" && styles.buttonActive]}
          onPress={() => setActiveTab("ownedNft")}
        >
          <ThemedText
            style={[styles.buttonText, activeTab === "ownedNft" && styles.buttonTextActive]}
          >
            Owned NFTs
          </ThemedText>
        </TouchableOpacity>
        <TouchableOpacity
          style={[styles.button, activeTab === "nft" && styles.buttonActive]}
          onPress={() => setActiveTab("nft")}
        >
          <ThemedText
            style={[styles.buttonText, activeTab === "nft" && styles.buttonTextActive]}
          >
            NFT Collections
          </ThemedText>
        </TouchableOpacity>
