...
import { WalletConnectRequestError, WalletConnectSignRequestPrams, WalletConnectTransactionRequestParams, WalletConnectSwitchEthereumChainRequestParams } from "thirdweb/dist/types/wallets/wallet-connect/receiver/types";
      ...
      const initWalletConnect = async () => {
        try {
          const customHandlers: {
            ...
            personal_sign: async ({ account, chainId, params }) => {
            ...
            eth_sign: async ({ account, chainId, params }) => {
            ...
            eth_sendTransaction: async ({ account, chainId, params }) => {
              const [tx] = params as WalletConnectTransactionRequestParams;
        ...
        const checkWc = setInterval(() => {
          ...
          if (wcElements.length > 0) {
            wcElements.forEach(el => {
              ...
              el.removeAttribute("href"); // Prevent further clicks
            });
