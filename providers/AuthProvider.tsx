...
interface AuthProps {
  ...
  onRegister: (email: string, address: string) => Promise<any>;
  signIn: (email: string, address: string) => Promise<any>;
  userExist: (email: string, address: string) => Promise<any>;
  signOut: () => Promise<any>;
  initialized: boolean;
  isTherapist: boolean;
}
...
export const AuthProvider = ({ children }: any) => {
   ...
   */
  const signIn = async (email: string, address: string) => {
   ...
   */
  const register = async (email: string, address: string) => {
    console.log("recieveRequest", email)
  ...
  const userExist = async (email: string, address: string) => {
    console.log("recieveRequest", email)
    const result = await fetch(`${API_URL}/auth/userExist`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
      },
