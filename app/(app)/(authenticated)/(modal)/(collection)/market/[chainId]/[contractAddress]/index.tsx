...
import { ListingGridContract } from "@/components/NFT/ListingGrindContract";
...
export default function NftGalery() {
  ...
  return (
    ...
    <ListingGridContract contractAddresse={contractAddress.toString()}chainId={Number(chainId)} />
      </ThemedView>
    </ParallaxScrollView>
  );
};
